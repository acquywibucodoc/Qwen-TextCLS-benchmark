...
def run_cola_inference(max_examples=None):
    # Paths
    DATA_PATH = 'data/cola.json'
    CHECKPOINT_PATH = 'Txt_CLS/Qwenv2.5_COLA_results/checkpoint-241'
    RESULT_PATH = 'results/cola_inference_results.json'
...
if __name__ == '__main__':
    run_cola_inference(max_examples=None)  # Change or set to an integer for quick test 