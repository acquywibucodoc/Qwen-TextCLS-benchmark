...
def run_sst2_inference(max_examples=None):
    # Paths
    DATA_PATH = 'data/sst2.json'
    CHECKPOINT_PATH = 'Txt_CLS/SST2_classifier/checkpoint-5682'
    RESULT_PATH = 'results/sst2_inference_results.json'
...
if __name__ == '__main__':
    run_sst2_inference(max_examples=None)  # Change or set to an integer for quick test 